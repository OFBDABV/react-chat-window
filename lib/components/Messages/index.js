...
var _MarkdownMessage = require('./MarkdownMessage');

var _MarkdownMessage2 = _interopRequireDefault(_MarkdownMessage);
...
var Message = function (_Component) {
  ...
  Message.prototype._renderMessageOfType = function _renderMessageOfType(type) {
    switch (type) {
      case 'markdown':
        return _react2.default.createElement(_MarkdownMessage2.default, this.props.message);
      case 'text':
